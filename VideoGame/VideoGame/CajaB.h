...
public:
	...
	void dibujarBomba(Graphics^ g, Bitmap^ bmpBomba, int xJugador, int yJugador, int** matriz) {
		if (validarLugar(xJugador, yJugador, matriz) == true) {
			...
			Rectangle aumento = Rectangle(x, y+30, 38, 38);
	...
	void DibujarExplosion(Graphics^ g, Bitmap^ bmpExplosionCentro, int** matriz) {
		...
		Rectangle centro = Rectangle(x, y+30, 50, 50);
		...
		if (matriz[y / 50][(x - 50) / 50] != 1) {
			...
			Rectangle izquierda = Rectangle(x - 50, y + 30, 50, 50);
		...
		if (matriz[y / 50][(x + 50) / 50] != 1) {
			...
			Rectangle derecha = Rectangle(x + 50, y + 30, 50, 50);
		...
		if (matriz[y / 50][(x + 50) / 50] != 1) {
			...
			Rectangle Puntaderecha = Rectangle(x + 100, y + 30, 50, 50);
		...
		if (matriz[y / 50][(x - 50) / 50] != 1) {
			...
			Rectangle Puntaizquierda = Rectangle(x - 100, y + 30, 50, 50);
		...
		Rectangle VerticalSuperior = Rectangle(x, y - 50 + 30, 50, 50);
		Rectangle VerticalInferior = Rectangle(x, y + 50 + 30, 50, 50);
		...
		if (matriz[(y - 50) / 50][x / 50] != 1) {
			...
			Rectangle PuntaSuperior = Rectangle(x, y - 100 + 30, 50, 50);
		...
		if (matriz[(y + 50) / 50][x / 50] != 1) {
			...
			Rectangle PuntaInferior = Rectangle(x, y + 100 + 30, 50, 50);
